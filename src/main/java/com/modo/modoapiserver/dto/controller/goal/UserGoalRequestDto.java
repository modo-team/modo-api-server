...
public class UserGoalRequestDto {
    @Schema(description = "목표 제목", required = false)
    private String title;

    @Schema(description = "목표 아이콘", required = false)
    private String icon;

    @Schema(description = "목표 난이도. 0: 쉬움, 1: 보통, 2: 어려움, (3: 안하면뒤진다. 추후 추가예정)", required = false)
    ...
    @Schema(description = "목표 날짜", required = false)
